...
function openSheetModal(tId = null, pEmail = null, isReadOnly = false, vaultId = null) {
    ...
    if (iframe) {
        if (vaultId) {
            ...
            iframe.src = `Ficha site/index.html?v=8&tableId=vault_${vaultId}&playerEmail=${currentUser.email}&readOnly=false&vaultId=${vaultId}`;
        } else {
            let tableId = tId;
            ...
            if (tableId && playerEmail) {
                iframe.src = `Ficha site/index.html?v=8&tableId=${tableId}&playerEmail=${playerEmail}&readOnly=${isReadOnly}`;
            } else {
                iframe.src = `Ficha site/index.html?v=8`;
            }
        }
    }
